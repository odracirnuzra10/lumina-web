...
PAGES.append({
    ...
    "nav_active": "/",
    "kicker": "E-E-A-T",
    "title": "Equipo Protocolo Lumina | CEO y profesionales altamente capacitados",
    "description": "CEO Ricardo Alfredo Oyarzún Acuña y profesionales altamente capacitados en Protocolo Lumina (OACG Group). Evaluación P3 y protocolos faciales coreanos. Plantilla honesta: no fichas clínicas inventadas.",
    "h1": "Quién está detrás de <em>Protocolo Lumina</em>?",
    "h1_text": "Quién está detrás de Protocolo Lumina?",
    "answer": "Protocolo Lumina es operado por la red OACG Group, la misma de Método Hebe, Clinera y Metricads. El CEO es Ricardo Alfredo Oyarzún Acuña. Las evaluaciones P3 y los tratamientos faciales los realizan profesionales altamente capacitados en cada sede (Vitacura, Concón, Los Ángeles). En esta página no inventamos nombres de tratantes ni fichas clínicas.",
    ...
    "citations": [],
    "faqs": [
        ("Quién es el CEO?", "Ricardo Alfredo Oyarzún Acuña. Fundador y CEO de la red. No es el profesional tratante de cada sesión."),
        ("Publican el nombre de cada profesional?", "No. En sala trabajan profesionales altamente capacitados. No añadimos fichas clínicas ni bios inventadas."),
        ("Las páginas de tratamiento quién las revisa?", "La organización Protocolo Lumina, con fecha de revisión visible. La única persona nombrada en página es el CEO."),
        ("Trabajan medicos o solo esteticistas?", "En sala trabajan profesionales altamente capacitados. No publicamos títulos individuales ni currículums inventados."),
        ("Puedo pedir un profesional en concreto?", "Al agendar la P3 se coordina sede y agenda. No prometemos un nombre de tratante."),
    ...
    "body": body([
        ...
        p("Google y las IA premian E-E-A-T. Tambien penalizan autores fantasma. Preferimos una ficha honesta: organización identificable, parent OACG Group, tres sedes con direccion, y un solo nombre de persona: el CEO Ricardo Alfredo Oyarzún Acuña. El resto del equipo se presenta como profesionales altamente capacitados. No añadimos fichas de clínicos."),
        h2("Cómo se trabaja hoy"),
        p("La puerta de entrada es la Evaluación P3 (45 minutos, $27.990). Ahi se mapea la piel y se indica cuales de las 18 tecnologías entran al plan. Los tratamientos no se venden por DM. El consentimiento y la foto clínica son parte del estandar, no un extra."),
        h2("Formacion en protocolo coreano"),
        p("Las tecnologías (EndoJiwoo, Cuky HIFU, Sakura, Bio Minji, etc.) las aplican profesionales altamente capacitados, bajo SOP de la red. OACG menciona estandarizacion con Clinera y SOPs."),
        h2("Quién aparece con nombre"),
        p("La única persona nombrada en esta página es Ricardo Alfredo Oyarzún Acuña, CEO. No publicamos números de Superintendencia ni bios inventadas de tratantes."),
        h2("Revision de contenidos"),
        p("Cada página clínica lleva revisión de la organización Protocolo Lumina y dateModified visible. El byline no inventa un director médico."),
    ]),
})
